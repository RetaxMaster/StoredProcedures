/* Recupera un único registro de convenios filtrándolo por algún campo */
/*DELIMITER $$ 

DROP PROCEDURE IF EXISTS sp_p_get_cacvns_byAnyField$$*/

CREATE PROCEDURE sp_p_get_cacvns_byAnyField (
