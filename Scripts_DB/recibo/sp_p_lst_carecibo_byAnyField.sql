/* Recupera una lista de recibo filtrándolo por algún campo */
/*DELIMITER $$ 

DROP PROCEDURE IF EXISTS sp_p_lst_carecibo_byAnyField$$*/

CREATE PROCEDURE sp_p_lst_carecibo_byAnyField (
