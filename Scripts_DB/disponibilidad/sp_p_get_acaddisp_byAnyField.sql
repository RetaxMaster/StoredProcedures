/* Recupera un único registro de cursos disponibles filtrándolo por algún campo */
/*DELIMITER $$ 

DROP PROCEDURE IF EXISTS sp_p_get_acaddisp_byAnyField$$*/

CREATE PROCEDURE sp_p_get_acaddisp_byAnyField (
...
BEGIN
    ...
    ELSE
        ...
        SELECT
            ...
            tbl_acadplans.temario AS id_plan,
