/* Recupera una lista de impuesto de factura filtrándolo por algún campo */
/*DELIMITER $$ 

DROP PROCEDURE IF EXISTS sp_p_lst_cafctrimp_byAnyField$$*/

CREATE PROCEDURE sp_p_lst_cafctrimp_byAnyField (
