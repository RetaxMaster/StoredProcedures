/* Recupera un único registro de pie de factura filtrándolo por algún campo */
/*DELIMITER $$ 

DROP PROCEDURE IF EXISTS sp_p_get_cafctrfoo_byAnyField$$*/

CREATE PROCEDURE sp_p_get_cafctrfoo_byAnyField (
