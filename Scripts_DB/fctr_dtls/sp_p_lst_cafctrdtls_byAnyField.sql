/* Recupera una lista de detalle de factura filtrándolo por algún campo */
/*DELIMITER $$ 

DROP PROCEDURE IF EXISTS sp_p_lst_cafctrdtls_byAnyField$$*/

CREATE PROCEDURE sp_p_lst_cafctrdtls_byAnyField (
