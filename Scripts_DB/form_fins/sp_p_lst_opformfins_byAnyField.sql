/* Recupera una lista de formulario de finalización filtrándolo por algún campo */
/*DELIMITER $$ 

DROP PROCEDURE IF EXISTS sp_p_lst_opformfins_byAnyField$$*/

CREATE PROCEDURE sp_p_lst_opformfins_byAnyField (
