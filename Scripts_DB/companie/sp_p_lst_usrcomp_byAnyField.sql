/* Recupera una lista de compañías filtrándolo por algún campo */
/*DELIMITER $$ 

DROP PROCEDURE IF EXISTS sp_p_lst_usrcomp_byAnyField$$*/

CREATE PROCEDURE sp_p_lst_usrcomp_byAnyField (
