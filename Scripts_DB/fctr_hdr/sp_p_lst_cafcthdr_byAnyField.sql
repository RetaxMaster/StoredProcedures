/* Recupera una lista de cabezera de factura filtrándolo por algún campo */
/*DELIMITER $$ 

DROP PROCEDURE IF EXISTS sp_p_lst_cafcthdr_byAnyField$$*/

CREATE PROCEDURE sp_p_lst_cafcthdr_byAnyField (
