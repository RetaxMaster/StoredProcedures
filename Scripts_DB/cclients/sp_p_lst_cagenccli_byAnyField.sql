/* Recupera una lista de contacto de clientes filtrándolo por algún campo */
/*DELIMITER $$ 

DROP PROCEDURE IF EXISTS sp_p_lst_cagenccli_byAnyField$$*/

CREATE PROCEDURE sp_p_lst_cagenccli_byAnyField (
